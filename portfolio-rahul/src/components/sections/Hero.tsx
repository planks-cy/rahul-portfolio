...
export function Hero() {
  return (
    ...
    >
      {/* Ambient background trace — decorative, low-opacity, static on
          reduced motion since it has no animation of its own. */}
      <svg
      ...
      >
        ...
        <motion.div variants={item} className="mt-6 max-w-xl">
          ...
          <p className="text-lg text-paper/70 md:text-xl">
